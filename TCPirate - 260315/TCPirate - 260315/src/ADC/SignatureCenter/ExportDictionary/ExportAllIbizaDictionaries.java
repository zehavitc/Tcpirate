...
public class ExportAllIbizaDictionaries {
    private static ExportAllIbizaDictionaries ourInstance = null;
    ...
    private static final int OPTION_FEATURE_PACK = 11;
    ...
    private static final String QUERY_ALL_DICTIONARIES = "select dict_name from tblDictionaries where min_ver <= 350 and max_ver is null and dict_isDeleted = 0";

    public static ExportAllIbizaDictionaries getInstance() {
        if (ourInstance == null)
            ourInstance = new ExportAllIbizaDictionaries();
    ...
    private ExportAllIbizaDictionaries() {
    }
    ...
    private void exportDictionaries() {
        ...
        try {
            while (rs.next()) {
                ...
                String[] args = null;
                if (m_ibiza_fp)
                    args = new String[] {"-v", "-fp", "-Dh", "iis", "-d", dict_name, "-of", m_output_dir + File.separator + dict_name + ".xml"};
                else
                    args = new String[] {"-v", "-Dh", "iis", "-d", dict_name, "-of", m_output_dir + File.separator + dict_name + ".xml"};


                ExportIbizaDictionary.exportDictionary(args);
            }
    ...
    public static void main(String[] argv) {
        ExportAllIbizaDictionaries obj = getInstance();
